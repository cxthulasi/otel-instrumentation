...
export default function HomePage() {
  ...
  useEffect(() => {
    trackCustomEvent('page_view', { page: 'home' });
  }, []);

  const handleButtonClick = (buttonName: string) => {
    trackCustomEvent('button_click', { buttonName, page: 'home' });
    ...
    <ErrorBoundary>
      <Container maxW={'3xl'}>
        ...
        <Text color={'gray.500'}>
          ...
          Navigate through the application to see how user interactions and API calls
        ...
        <Flex justify="center" mt={10}>
          <GitHubRepoLink variant="compact" showStats={false} />
        </Flex>
      </Stack>
    </Container>
    </ErrorBoundary>
